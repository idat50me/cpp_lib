...
data:
  ...
  bundledCode: "#line 2 \"structure/matrix.cpp\"\n\r\n#ifndef call_include\r\n#define\
    ...
    \n\r\ntemplate<typename T>\r\nstruct matrix{\r\nprivate:\r\n\tvector<vector<T>>\
    \ m;\r\n\r\npublic:\r\n\tmatrix() : m(0, vector(0)) {}\r\n\tmatrix(int h, int\
    \ w) : m(h, vector(w)) {}\r\n\tmatrix(int h, int w, const T &init) : m(h, vector(w,\
    \ init)) {}\r\n\r\n\tvoid assign(int h, int w) { m = vector(h, vector(w)); }\r\
  ...
  code: "#pragma once\r\n\r\n#ifndef call_include\r\n#define call_include\r\n#include\
    ...
    \ h, int w, const T &init) : m(h, vector(w, init)) {}\r\n\r\n\tvoid assign(int\
    \ h, int w) { m = vector(h, vector(w)); }\r\n\tvoid assign(int h, int w, const\
    \ T init) { m = vector(h, vector(w, init)); }\r\n\r\n\tint height() const {\r\n\
    \t\treturn m.size();\r\n\t}\r\n\r\n\tint width() const {\r\n\t\tif(height()==0)\
    \ return 0;\r\n\t\treturn m[0].size();\r\n\t}\r\n\r\n\tvoid in() {\r\n\t\tfor(int\
