...
data:
  ...
  code: "#pragma once\r\n\r\n#ifndef call_include\r\n#define call_include\r\n#include\
    ...
    \n\t\tnode.resize(2*siz-1, e_);\r\n\t}\r\n\tsegtree(vector<T> v, const F func,\
    \ const T e) : N(v.size()), op(func), e_(e) {\r\n\t\twhile(siz < N) siz *= 2;\r\
    ...
    \n\t\tif(L<=l && r<=R) return node[id];\r\n\t\tT vl = get__(L, R, 2*id+1, l, (l+r)/2);\r\
    \n\t\tT vr = get__(L, R, 2*id+2, (l+r)/2, r);\r\n\t\treturn op(vl, vr);\r\n\t\
    }\r\npublic:\r\n};\r\n"
  dependsOn: []
