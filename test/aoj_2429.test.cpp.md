...
data:
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2429\"\r\n\r\n\
    ...
    \n\r\n\tauto stat = mcf.stat();\r\n\tqueue<int> F,T;\r\n\tqueue<string> qstr;\r\
    \n\tfor(int i=0; i<stat.size(); i++) {\r\n\t\tif(stat[i].from==s || stat[i].to==t)\
    \ continue;\r\n\t\tint from=stat[i].from, to=stat[i].to-N;\r\n\t\tif(stat[i].used_cap==1)\
    \ {\r\n\t\t\tif(mp[from][to]=='.') {\r\n\t\t\t\tF.push(from+1), T.push(to+1);\r\
    \n\t\t\t\tqstr.push(\"write\");\r\n\t\t\t}\r\n\t\t}\r\n\t\telse if(mp[from][to]=='o')\
    \ {\r\n\t\t\tF.push(from+1), T.push(to+1);\r\n\t\t\tqstr.push(\"erase\");\r\n\t\
    \t}\r\n\t}\r\n\r\n\tcout<<F.size()<<endl;\r\n\twhile(!F.empty()) {\r\n\t\tint\
    \ from=F.front(), to=T.front();\r\n\t\tstring str=qstr.front();\r\n\t\tF.pop();\
  ...
  requiredBy: []
  timestamp: '2020-12-13 01:41:50+09:00'
