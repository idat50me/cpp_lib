...
data:
  ...
  bundledCode: "#line 1 \"test/yuki_1013.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1013\"\
    ...
    \ init;\r\n\t\tfor(int k = 0; t; k++) {\r\n\t\t\tif(t & 1) {\r\n\t\t\t\tres =\
    \ f(res, data[k][id]);\r\n\t\t\t\tid = table[k][id];\r\n\t\t\t}\r\n\t\t\tt >>=\
    \ 1;\r\n\t\t}\r\n\t\treturn res;\r\n\t}\r\n};\r\n#line 10 \"test/yuki_1013.test.cpp\"\
    \n\r\nint main() {\r\n\tint N, K;\r\n\tcin >> N >> K;\r\n\tvector<long long> P(N\
    \ + 1), Pv(N + 1);\r\n\tvector<int> v(N + 1);\r\n\tP[0] = v[0] = 0;\r\n\tfor(int\
    \ i = 1; i <= N; i++) {\r\n\t\tcin >> P[i];\r\n\t\tv[i] = (i + P[i] - 1) % N +\
    \ 1;\r\n\t}\r\n\r\n\tdoubling<long long> db(v, P, K, [](long long l, long long\
    \ r) { return l + r; });\r\n\tfor(int i = 1; i <= N; i++) cout << db.get(i, i,\
    \ K) << endl;\r\n}\r\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1013\"\r\n\r\n#ifndef\
    ...
    vector<int> v(N + 1);\r\n\tP[0] = v[0] = 0;\r\n\tfor(int i = 1; i <= N; i++) {\r\
    \n\t\tcin >> P[i];\r\n\t\tv[i] = (i + P[i] - 1) % N + 1;\r\n\t}\r\n\r\n\tdoubling<long\
    \ long> db(v, P, K, [](long long l, long long r) { return l + r; });\r\n\tfor(int\
    \ i = 1; i <= N; i++) cout << db.get(i, i, K) << endl;\r\n}\r\n"
  dependsOn:
  - dp/doubling.cpp
  ...
  verifiedWith: []
documentation_of: test/yuki_1013.test.cpp
layout: document
redirect_from:
- /verify/test/yuki_1013.test.cpp
- /verify/test/yuki_1013.test.cpp.html
