...
data:
  ...
  bundledCode: "#line 1 \"test/yuki_0186.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/186\"\
    ...
    m *= M[i] / d;           // m = lcm(m, M[i])\r\n\t\tr %= m;                  //\
    \ r = r % lcm(m, M[i])\r\n\t\tif(r < 0) r += m;\r\n\t}\r\n\treturn make_pair(r,\
    \ m);\r\n}\r\n#line 10 \"test/yuki_0186.test.cpp\"\n\r\nint main() {\r\n\tint\
  ...
  requiredBy: []
  timestamp: '2021-03-01 01:07:33+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yuki_0186.test.cpp
layout: document
redirect_from:
- /verify/test/yuki_0186.test.cpp
- /verify/test/yuki_0186.test.cpp.html
