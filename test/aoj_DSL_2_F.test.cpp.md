...
data:
  ...
  bundledCode: "#line 1 \"test/aoj_DSL_2_F.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DSL_2_F\"\
    ...
    \ FM = function<M(M,M)>;\r\n\r\nprivate:\r\n\tint siz=1, N;\r\n\tvector<T> node;\r\
    \n\tvector<M> lazy;\r\n\tconst F op;\r\n\tconst FU f_upd;\r\n\tconst FM f_lz;\r\
    \n\tconst T ex;\r\n\tconst M em;\r\n\r\npublic:\r\n\tsegtree_lazy(int n, const\
    \ F op, const FU f_upd, const FM f_lz, const T ex, const M em)\r\n\t: N(n), op(op),\
    \ f_upd(f_upd), f_lz(f_lz), ex(ex), em(em) {\r\n\t\twhile(siz < N) siz <<= 1;\r\
    \n\t\tnode.resize(2*siz-1, ex);\r\n\t\tlazy.resize(2*siz-1, em);\r\n\t}\r\n\t\
    segtree_lazy(vector<T> &v, const F op, const FU f_upd, const FM f_lz, const T\
    \ ex, const T em)\r\n\t: N(v.size()), op(op), f_upd(f_upd), f_lz(f_lz), ex(ex),\
    ...
    \ (l+r)/2, r);\r\n\t\treturn op(vl, vr);\r\n\t}\r\n};\r\n#line 10 \"test/aoj_DSL_2_F.test.cpp\"\
