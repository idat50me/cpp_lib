...
data:
  ...
  bundledCode: "#line 1 \"test/aoj_ALDS1_1_B.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ALDS1_1_B\"\
    ...
    \ d) return -1;\r\n\tx *= c / d;\r\n\tif(a < 0) x = -x;\r\n\ty *= c / d;\r\n\t\
    if(b < 0) y = -y;\r\n\treturn d;\r\n}\r\n#line 10 \"test/aoj_ALDS1_1_B.test.cpp\"\
    \n\r\nint main() {\r\n\tint x,y; cin>>x>>y;\r\n\tlong long z;\r\n\tcout<<extgcd(x,y,z,z)<<endl;\r\
    \n}\r\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/ALDS1_1_B\"\r\
    \n\r\n#ifndef call_include\r\n#define call_include\r\n#include <bits/stdc++.h>\r\
  ...
  verifiedWith: []
documentation_of: test/aoj_ALDS1_1_B.test.cpp
layout: document
redirect_from:
- /verify/test/aoj_ALDS1_1_B.test.cpp
- /verify/test/aoj_ALDS1_1_B.test.cpp.html
